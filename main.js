...
export const fn = (a, b, c) => {
    ...
    if ((a + b + c) > 39) { ///If the Sum of the three values is more than 39 
    ...
    else if (a < 0 || b < 0 || c < 0) { ////////////if one of the three values is negative (less than zero)
     console.log("Todos los numeros deben de ser positivos");///Print Error message via console
     throw error();/////Throwing error to vitest
    }

    else if ((a + b + c) % 3 != 0) {//////If the sum of the three numbers is not divisible by three (module 3 is not equal 0)
        console.log("Lo sentimos,el numero de empanadas debe de ser divisible entre 3");///Print Error message via console
        throw error();/////Throwing error to vitest
    }
